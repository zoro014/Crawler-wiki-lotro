...
# Defining pages
starting_page = "https://lotro-wiki.com/index.php/Epic_Quests"
...
def extract_title(page):
    ...
    title = page[start_title + len("<title>"):end_title]
    return title
...
def url_parse(url):
    ...
    f = furl.furl(url)  # parse the given url
    ...
    while i <= 9:
        ...
        i = i + 1
        f = furl.furl(url)  # Parse after every loop to update the values of url parameters
    return (url, flag)
